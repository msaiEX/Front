...
const ReservedCard = ({ transaction_type, transaction_date, withdrawal_amount, deposit_amount, reservation_period, currency_code, handleReservedCardClick }) => {
  ...
  return (
    <div onClick={handleReservedCardClick} className="cursor-pointer">
