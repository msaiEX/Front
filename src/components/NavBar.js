    ...
    <nav className="w-[1140px] h-[55px] px-10 bg-background">
      ...
      >
        <div name="logobox" className="flex items-center">
          <Box className="w-[36px] h-[36px]">
            <Image
              src={process.env.PUBLIC_URL + "/image/window_logo.png"}
              alt="hana_logo"
            />
          </Box>
          {/* <Image
            src={process.env.PUBLIC_URL + "/image/hanaex_logo3.png"}
            className="h-[18px]"
            alt="hanaex_logo"
          /> */}
          <div className="text-xl font-bold text-gray-500">
            <span className="">Msai</span>
        ...
        <div>
          {user ? (
            ...
            <div className="flex items-center gap-2">
              <Text className="bg-red-200 text-red-600 px-1 rounded-sm">
                LV{user.user_lv}
              </Text>
