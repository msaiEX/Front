    ...
    <div className="w-full px-5">
      ...
      <div className="flex justify-center bg-[#d6e1fd] my-4">
        <button
          ...
          className={`w-[25%] px-2 py-2 rounded ${
            activeButton === "year"
      ...
      <div
        name="1-2"
        className="bg-blue-50 h-[400px] rounded-xl mt-6 py-10 px-2"
      >
      ...
      <div className="flex mt-6 gap-2">
        <a
          ...
          download // 다운로드 속성 추가
          className="px-4 py-2 gap-1 bg-blue-200 text-blue-600 rounded flex items-center border border-transparent hover:bg-white hover:border-blue-700 hover:text-blue-700 transition-all duration-300"
        >
          반기상황
          <IoMdDownload />
        </a>
