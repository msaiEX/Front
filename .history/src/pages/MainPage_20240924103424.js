      ...
      <div className="w-[1140px] h-full flex flex-col py-10 px-10">
        ...
        <div className="w-full flex-grow py-5">
          ...
          {filteredData.length > 10 && (
            <button onClick={() => setShowAll(!showAll)} className='flex justify-center'>
              {showAll ?
                <div className='flex items-center'>접기 <TiArrowSortedDown /></div> :
                <div className='flex items-center'>자세히 보기 <TiArrowSortedUp /></div> 
              }
            </button>
          )}
        </div>
