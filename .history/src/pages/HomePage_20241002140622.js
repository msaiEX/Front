  ...
  return (
    <div className="relative">
      ...
      <div className='absolute z-100 top-[800px]'>
        <div
          className="block mx-auto border-2 border-white rounded-md w-5 h-8 box-border"
          name="mouse"
        >
          <div
            className="absolute left-[8px] transform -translate-x-1/2 top-[10%] w-[3px] h-[5px] bg-white rounded-full"
