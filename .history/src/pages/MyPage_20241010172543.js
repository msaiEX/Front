                      ...
                      <SwiperSlide>
                        <CurrencyAsset
                          ...
                          currentSellAmount={
                            usdNetAmount !== 0
                              ? formatNumber(
                                  maxPeriodData.USD.remit_send * usdNetAmount
                                )
                              : "0"
                          }
                          expectedExchangeRate={maxPeriodData.USD.remit_send}
                          expectedProfit={
                            usdBuyTotal -
                            usdSellTotal -
                            maxPeriodData.USD.remit_send * usdNetAmount
                      ...
                      <SwiperSlide>
                        <CurrencyAsset
                          ...
                          currentSellAmount={
                            jpyNetAmount !== 0
                              ? formatNumber(
                                  maxPeriodData.JPY.remit_send * jpyNetAmount
                                )
                              : "0"
                          }
                          expectedExchangeRate={maxPeriodData.JPY.remit_send}
                          expectedProfit={
                            jpyBuyTotal -
                            jpySellTotal -
                            maxPeriodData.JPY.remit_send * jpyNetAmount
                      ...
                      <SwiperSlide>
                        <CurrencyAsset
                          ...
                          currentSellAmount={
                            cnyNetAmount !== 0
                              ? formatNumber(
                                  maxPeriodData.CNY.remit_send * cnyNetAmount
                                )
                              : "0"
                          }
                          expectedExchangeRate={maxPeriodData.CNY.remit_send}
                          expectedProfit={
                            cnyBuyTotal -
                            cnySellTotal -
                            maxPeriodData.CNY.remit_send * cnyNetAmount
                      ...
                      <SwiperSlide>
                        <CurrencyAsset
                          ...
                          currentSellAmount={
                            eurNetAmount !== 0
                              ? formatNumber(
                                  maxPeriodData.EUR.remit_send * eurNetAmount
                                )
                              : "0"
                          }
                          expectedExchangeRate={maxPeriodData.EUR.remit_send}
                          expectedProfit={
                            eurBuyTotal -
                            eurSellTotal -
                            maxPeriodData.EUR.remit_send * eurNetAmount
