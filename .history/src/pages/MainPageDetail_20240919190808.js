                ...
                <PopoverBody>
                  <table style={{ borderCollapse: "collapse", width: "100%" }}>
                    <thead>
                      ...
                      >
                        <th style={{ padding: "8px" }}>레벨</th>
                        <th style={{ padding: "8px" }}>스코어</th>
                        <th style={{ padding: "8px" }}>환율 우대율</th>
                      </tr>
                    </thead>
                    <tbody>
                      <tr style={{ textAlign: "center" }}>
                        <td style={{ padding: "8px" }}>레벨 5</td>
                        <td style={{ padding: "8px" }}>25001 이상</td>
                        <td style={{ padding: "8px" }}>
                          USD: 90% / JPY, EUR: 60% / 기타: 30%
                        </td>
                      </tr>
                      <tr style={{ textAlign: "center" }}>
                        <td style={{ padding: "8px" }}>레벨 4</td>
                        <td style={{ padding: "8px" }}>15001 ~ 25000</td>
                        <td style={{ padding: "8px" }}>
                          USD: 85% / JPY, EUR: 55% / 기타: 30%
                        </td>
                      </tr>
                      <tr style={{ textAlign: "center" }}>
                        <td style={{ padding: "8px" }}>레벨 3</td>
                        <td style={{ padding: "8px" }}>10001 ~ 15000</td>
                        <td style={{ padding: "8px" }}>
                          USD: 80% / JPY, EUR: 50% / 기타: 20%
                        </td>
                      </tr>
                      <tr style={{ textAlign: "center" }}>
                        <td style={{ padding: "8px" }}>레벨 2</td>
                        <td style={{ padding: "8px" }}>5101 ~ 10000</td>
                        <td style={{ padding: "8px" }}>
                          USD: 75% / JPY, EUR: 45% / 기타: 20%
                        </td>
                      </tr>
                      <tr style={{ textAlign: "center" }}>
                        <td style={{ padding: "8px" }}>레벨 1</td>
                        <td style={{ padding: "8px" }}>0 ~ 5100</td>
                        <td style={{ padding: "8px" }}>
