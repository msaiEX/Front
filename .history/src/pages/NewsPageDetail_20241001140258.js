...
const NewsPageDetail = () => {
  ...
  const gptBoxRef = useRef(null);
  const contentBoxRef = useRef(null);

  const [gptBoxOpen, setGptBoxOpen] = useState(false);
  ...
  const handleGpttext = () => {
    setGptBoxOpen(!gptBoxOpen);
  };

  const handleFulltext = () => {
    setContentBoxOpen(!contentBoxOpen);
  };
  ...
  return (
    <div className="w-[960px] flex flex-col py-1 px-10 mt-10">
      ...
      <div
        ...
        style={{
          maxHeight: gptBoxOpen ? `${gptBoxRef.current.scrollHeight}px` : "100px",
        }}
      >
        <div ref={gptBoxRef}>
          {gptBoxOpen ? (
        ...
        <div className="flex justify-center items-center mt-2">
          ...
          {gptBoxOpen ? <TiArrowSortedUp /> : <TiArrowSortedDown />}
        </div>
      </div>
      ...
      <div
        ...
        style={{
          maxHeight: contentBoxOpen ? `${contentBoxRef.current.scrollHeight}px` : "200px",
      ...
      >
        <div ref={contentBoxRef}>
          ...
          <div className="flex items-center">
            ...
            {contentBoxOpen ? <TiArrowSortedUp /> : <TiArrowSortedDown />}
          </div>
        </div>
      </div>
      <TitleText title="관련뉴스" />
