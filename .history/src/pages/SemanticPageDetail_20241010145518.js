        ...
        <ModalContent>
          ...
          <ModalBody>
            ...
            <div className="p-3 bg-green-100 rounded-xl mt-6">
                ...
                <Text className="text-sm font-semibold text-slate-600 px-3 mb-3">긍정요인</Text>
                <Text className="text-sm font-semibold text-slate-600 px-3 mb-3">
                최근 미국의 경기 둔화 신호와 함께 금리 인상이 지속될 가능성이 언급되었습니다. PDF 자료에서도 미국의 지속적인 금리 인상과 경기 침체 가능성이 높아지고 있다는 점이 반복적으로 언급되고 있으며, 이는 달러 투자에 부정적 영향을 미칩니다.
                </Text>
