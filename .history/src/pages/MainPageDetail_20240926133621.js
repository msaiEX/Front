  ...
  return (
    <div className="w-[960px] flex flex-col py-1 px-10">
      ...
      >
        ...
        <button
          onClick={onOpen}
          className="text-white bt-background px-4 rounded hover:bg-white hover:border hover:border-[#009577] hover:text-[#009577] transition-all"
          style={{ height: "42px", width: "50px" }}
        >
          <Image
            src='/image/ai_icon2.png'
            className='h-[18px] w-[24px] text-white'
          >
