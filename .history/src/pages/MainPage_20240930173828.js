        ...
        <div className="w-full flex-grow py-5">
          ...
          <div className="flex justify-center mt-3">
            {filteredData.length > 10 && (
              <button onClick={() => setShowAll(!showAll)}>
                {showAll ? (
                  <div className="w-[120px] flex justify-center items-center rounded-full p-1 bg-green-400 text-white hover:bg-white hover:text-green-500 border border-green-500 transition duration-300">
                    접기 <TiArrowSortedUp />
                  </div>
                ) : (
                  <div className="w-[120px] flex justify-center items-center rounded-full p-1 bg-green-400 text-white hover:bg-white hover:text-green-500 border border-green-500 transition duration-300">
