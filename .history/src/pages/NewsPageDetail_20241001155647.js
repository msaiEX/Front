...
//   // 더보기 버튼 클릭 시 모든 뉴스를 보여주기 위해 visibleNewsCount를 업데이트
//   const handleShowMoreNews = () => {
//     setVisibleNewsCount(newsConsumData.length); // 전체 뉴스를 보여줌
//   };
...
//       {/* 더보기 버튼 */}
//       {visibleNewsCount < newsConsumData.length && (
  ...
  return (
    <div className="w-[960px] flex flex-col py-1 px-10 mt-10">
      ...
      {newsConsumData.length > 5 && (
        <div className="flex justify-center mt-4">
          <button
            className="w-[48px]px-4 py-2 bg-green-600 rounded-full text-white rounded hover:bg-green-700 transition-colors duration-300"
