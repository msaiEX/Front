...
const NewsPageDetail = () => {
  ...
  useEffect(() => {
    ...
    if (gptBoxRef.current) {
      setGptBoxHeight(gpttext ? `${gptBoxRef.current.scrollHeight}px` : "0px");
    }
  }, [gpttext]);
  ...
  useEffect(() => {
    ...
    if (contentBoxRef.current) {
      setContentBoxHeight(fulltext ? `${contentBoxRef.current.scrollHeight}px` : "0px");
    }
  }, [fulltext]);
  ...
  return (
    <div className="w-[960px] flex flex-col py-1 px-10 mt-10">
      ...
      <div
        ...
        style={{ boxShadow: "0 2px 5px rgba(0, 0, 0, 0.1)", maxHeight: contentBoxHeight }}
      >
        <Image
          src={consumData.imageUrl}
          className="w-[750px] h-[300px] object-contain bg-slate-100 rounded-xl"
