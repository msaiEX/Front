                    ...
                    >
                      <SwiperSlide>
                        <CurrencyAsset
                          ...
                          currentSellAmount={
                            usdNetAmount !== 0
                              ? formatNumber(
                                (maxPeriodData.USD.remit_send - maxPeriodData.USD.remit_send * rates )* usdNetAmount
                                )
                              : "0"
                          }
                          expectedExchangeRate={(maxPeriodData.USD.remit_send - maxPeriodData.USD.remit_send * rates )}
                          expectedProfit={
                            usdBuyTotal -
                            usdSellTotal -
                            (maxPeriodData.USD.remit_send - maxPeriodData.USD.remit_send * rates )* usdNetAmount
                      ...
                      <SwiperSlide>
                        <CurrencyAsset
                          ...
                          currentSellAmount={
                            jpyNetAmount !== 0
                              ? formatNumber(
                                  (maxPeriodData.JPY.remit_send - maxPeriodData.JPY.remit_send * rates ) * jpyNetAmount
                                )
                              : "0"
                          }
                          expectedExchangeRate={maxPeriodData.JPY.remit_send - maxPeriodData.JPY.remit_send * rates}
                          expectedProfit={
                            jpyBuyTotal -
                            jpySellTotal -
                            (maxPeriodData.JPY.remit_send - maxPeriodData.JPY.remit_send * rates ) * jpyNetAmount
                      ...
                      <SwiperSlide>
                        <CurrencyAsset
                          ...
                          currentSellAmount={
                            cnyNetAmount !== 0
                              ? formatNumber(
                                (maxPeriodData.CNY.remit_send - maxPeriodData.CNY.remit_send * rates ) * cnyNetAmount
                                )
                              : "0"
                          }
                          expectedExchangeRate={maxPeriodData.CNY.remit_send - maxPeriodData.CNY.remit_send * rates}
                          expectedProfit={
                            cnyBuyTotal -
                            cnySellTotal -
                            (maxPeriodData.CNY.remit_send - maxPeriodData.CNY.remit_send * rates ) * cnyNetAmount
                      ...
                      <SwiperSlide>
                        <CurrencyAsset
                          ...
                          expectedExchangeRate={maxPeriodData.EUR.remit_send - maxPeriodData.EUR.remit_send * rates}
                          expectedProfit={
                            eurBuyTotal -
                            eurSellTotal -
                            (maxPeriodData.EUR.remit_send - maxPeriodData.EUR.remit_send * rates ) * eurNetAmount
                          ...
                          expectedProfitRate={
                            eurNetAmount !== 0
                              ? (
                                  (eurBuyTotal - eurSellTotal) /
                                  ((maxPeriodData.EUR.remit_send - maxPeriodData.EUR.remit_send * rates ))
                                ).toFixed(2)
                              : "0.00"
                          }
                        />
