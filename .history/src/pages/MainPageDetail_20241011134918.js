...
//       // Update state if filtered data is available
//       if (filteredTodayData.length > 0) {
//         const { remit_send, remit_receive } =
//           filteredTodayData[filteredTodayData.length - 1];
...
//         // Get the rate based on changeState, default to 0 if not found
...
//             </div>
//             <Text className='text-slate-570 text-sm ml-2 mt-2'>자료 : 하나은행, 하나금융경제연구소</Text>
//           </div>
//         </div>
//       </div>
...
const MainPageDetail = () => {
  ...
  console.log("aimodal", aiData.data)
  return (
    <div className="w-full h-full relative flex justify-center">
      <div className="w-[960px] flex flex-col py-1 px-10">
        {loading ? <Loading /> : null}
