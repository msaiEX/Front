    ...
    <>
      ...
      <Modal isOpen={isOpen} onClose={onClose}>
        ...
        <ModalContent>
          ...
          <ModalCloseButton />
          <ModalBody>
            <Text className='font-bold'>분석결과</Text>
            <div className='flex gap-2 mx-2'>
              <div className='flex border w-full bg-red-500 justify-center items-center'>
                <div className='flex flex-col items-center'>
                  <FaRegSmile className='text-white'/>
                  <Text>{ Number( consumData.positive ).toFixed(1) }%</Text>
                </div>
              </div>
              <div className='flex border w-full bg-blue-500 justify-center items-center'>
                <div className='flex flex-col items-center'>
                  <FaRegSadTear className='text-white' />
                  <Text>{ Number( consumData.nagative ).toFixed(1) }%</Text>
                </div>
              </div>
            </div>
