...
//         style={{
//           maxHeight: gpttext ? "500px" : "100px", // 상태에 따라 높이 변경
//           overflow: "hidden", // 내용이 넘칠 경우 숨김
//           transition: "max-height 0.5s ease", // 자연스러운 확장 애니메이션
//         }}
//       >
//         {gpttext === true ? (
//           <>
  ...
  return (
    <div className="w-[960px] flex flex-col py-1 px-10 mt-10">
      ...
      <div
        ...
        ref={summaryRef}
        style={{
          height: gpttext ? `${summaryRef.current.scrollHeight}px` : "100px", // 내용 크기만큼 확장
          overflow: "hidden",
      ...
      <div
        ...
        style={{
          boxShadow: "0 2px 5px rgba(0, 0, 0, 0.1)",
          height: fulltext ? `${contentRef.current.scrollHeight}px` : "200px", // 내용 크기만큼 확장
          overflow: "hidden",
          transition: "height 0.5s ease",
        }}
      >
