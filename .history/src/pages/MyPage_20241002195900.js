  ...
  useEffect(() => {
    ...
    const fetchAccountsData = async () => {
      try {
        ...
        console.log(buyTotalJPY)
        console.log(sellTotalJPY)
        console.log(netAmountJPY)
      } catch (error) {
        console.error("Error fetching account data:", error);
      } finally {
        setIsLoading(true);
                ...
                <div className="flex flex-col items-start ml-3">
                  ...
                  <div className="bg-white w-full rounded-2xl px-8 py-6 mt-4">
                    ...
                    <div className="flex justify-between">
                      ...
                      <div className="flex gap-1">
                        <Image
                          ...
                          alt="USD Flag"
                        ></Image>
                        <Text className="text-2xl font-bold">USD</Text>ß
                      </div>
                    </div>
                    ...
                    <CurrencyAsset
                      ...
                      currentSellAmount={formatNumber(1000 * jpyNetAmount)}
                      expectedExchangeRate="1000"
                      expectedProfit={formatNumber((jpyBuyTotal - jpySellTotal) - (1000 * jpyNetAmount))}
                      expectedProfitRate={((jpyBuyTotal - jpySellTotal) / (1000 * jpyNetAmount)).toFixed(2)}
                    />
                    ...
                    <CurrencyAsset
                      ...
                      currentSellAmount={formatNumber(171.48 * cnyNetAmount)}
                      expectedExchangeRate="171.48"
                      expectedProfit={formatNumber((cnyBuyTotal - cnySellTotal) - (171.48 * cnyNetAmount))}
                      expectedProfitRate={((cnyBuyTotal - cnySellTotal) / (171.48* cnyNetAmount)).toFixed(2)}
                    />
