...
//                           )}
//                           averageExchangeRate={formatNumber(
//                             (usdBuyTotal - usdSellTotal) / usdNetAmount
//                           )}
//                           currentSellAmount={formatNumber(
//                             1331.2 * usdNetAmount
//                           )}
//                           expectedExchangeRate="1331.2"
//                           expectedProfit={formatNumber(
//                             usdBuyTotal - usdSellTotal - 1331.2 * usdNetAmount
//                           )}
//                           expectedProfitRate={(
//                             (usdBuyTotal - usdSellTotal) /
//                             (1331.2 * usdNetAmount)
...
//                           expectedProfit={formatNumber(
//                             jpyBuyTotal - jpySellTotal - 1000 * jpyNetAmount
//                           )}
//                           expectedProfitRate={(
//                             (jpyBuyTotal - jpySellTotal) /
//                             (1000 * jpyNetAmount)
...
//                           expectedProfit={formatNumber(
//                             cnyBuyTotal - cnySellTotal - 171.48 * cnyNetAmount
//                           )}
//                           expectedProfitRate={(
//                             (cnyBuyTotal - cnySellTotal) /
//                             (171.48 * cnyNetAmount)
              ...
              <TabPanel>
                ...
                >
                  ...
                  <div className="mt-4">
                    ...
                    <Text>EUR 총 구매 금액 (buy): {formatNumber(eurBuyTotal)} EUR</Text>
                    <Text>EUR 총 판매 금액 (sell): {formatNumber(eurSellTotal)} EUR</Text>
                  </div>
                </div>
              </TabPanel>
                    ...
                    >
                      <SwiperSlide>
                        <CurrencyAsset
                          ...
                          expectedProfit={
                            usdBuyTotal - usdSellTotal - exchangeRates["USD"] * usdNetAmount
                              ? formatNumber(
                                  usdBuyTotal - usdSellTotal - exchangeRates["USD"] * usdNetAmount
                                )
                              : "0"
                      ...
                      <SwiperSlide>
                        <CurrencyAsset
                          ...
                          expectedProfit={
                            jpyBuyTotal - jpySellTotal - exchangeRates["JPY"] * jpyNetAmount
                              ? formatNumber(
                                  jpyBuyTotal - jpySellTotal - exchangeRates["JPY"] * jpyNetAmount
                                )
                              : "0"
                      ...
                      <SwiperSlide>
                        <CurrencyAsset
                          ...
                          expectedProfit={
                            cnyBuyTotal - cnySellTotal - exchangeRates["CNY"] * cnyNetAmount
                              ? formatNumber(
                                  cnyBuyTotal - cnySellTotal - exchangeRates["CNY"] * cnyNetAmount
                                )
                              : "0"
                      ...
                      <SwiperSlide>
                        <CurrencyAsset
                          currencyCode="EUR"
                          imageSrc="/image/eur_flag.png" // EUR 국기 이미지 경로
                          ...
                          expectedProfit={
                            eurBuyTotal - eurSellTotal - exchangeRates["EUR"] * eurNetAmount
                              ? formatNumber(
                                  eurBuyTotal - eurSellTotal - exchangeRates["EUR"] * eurNetAmount
                                )
                              : "0"
