      ...
      <Modal isOpen={isOpen} onClose={onClose}>
        ...
        <ModalContent width="80%" maxW="600px" maxH="520px">
          ...
          <ModalBody className='overflow-y-auto'>
            ...
            <div>
              <Text>긍정적 요인: 안전자산 수요 증가, 미국 경제의 안정적 성장세, 달러 강세에 따른 수익 기대 등이 긍정적 요인입니다. 미국의 금리 동결 또는 인하 기대감, 에너지 수출 증가 및 무역적자 감소도 긍정적 신호로 평가됩니다.</Text>
            </div>
            <Text className='font-bold text-xl mt-4 mb-2'>이유 및 상세 분석</Text>
