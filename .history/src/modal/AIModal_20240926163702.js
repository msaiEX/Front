        ...
        <Tabs variant="soft-rounded" colorScheme="green">
          ...
          <TabPanels>
            <TabPanel name="panel1">
              <Text className='text-lg'>하나AI는 내일</Text>
              <div className='flex'>
                <Text className='text-xl font-semibold'>원/달러 가격</Text>
                <Text className='text-xl'>을 얼마라고 예측했을까요?</Text>
              </div>
              <div className="flex">
                <Text className='text-2xl'>USD= </Text>
                <Text className='text-2xl'>{aiData.tomorrowPredict}원</Text>
              </div>
              <div className="flex">
