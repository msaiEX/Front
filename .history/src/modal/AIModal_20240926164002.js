        ...
        <Tabs variant="soft-rounded" colorScheme="green">
          ...
          <TabPanels>
            <TabPanel name="panel1">
              <Text className='text-lg leading-0'>하나AI는 내일</Text>
              <div className='flex'>
                <Text className='text-xl font-semibold leading-0'>원/달러 가격</Text>
                <Text className='text-xl leading-0'>을 얼마라고 예측했을까요?</Text>
              </div>
