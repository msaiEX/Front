              ...
              <div className='pt-12 pb-8 pl-8 pr-10 bg-[#252e32] rounded-xl'>
                <ResponsiveContainer width="100%" height={150}>
                  <ComposedChart data={data} barSize={100} barGap={20}>
                    {/* X축 */}
                    <XAxis dataKey="name" tick={{ fill: '#f2edd3' }}/>
                    {/* Y축 */}
                    <YAxis domain={[1325, 1335]} tick={{ fill: '#f2edd3' }}/>
                    {/* 툴팁 및 범례 */}
                    <Tooltip />
                    <Legend />
                    {/* Bar: 오늘 예측 값을 표시 */}
                    <Bar dataKey="today" fill="#fd5167" name="오늘 예측">
                      {/* 각 Bar의 위에 값을 표시 */}
                      <LabelList dataKey="today" position="top" tick={{ fill: '#f2edd3' }}/>
                    </Bar>
                    {/* Bar: 내일 예측 값을 표시 */}
                    <Bar dataKey="tomorrow" fill="#2e8efe" name="내일 예측">
                      {/* 각 Bar의 위에 값을 표시 */}
                      <LabelList dataKey="tomorrow" position="top" tick={{ fill: '#f2edd3' }}/>
                    </Bar>
                  </ComposedChart>
                </ResponsiveContainer>
              </div>
