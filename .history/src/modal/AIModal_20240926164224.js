        ...
        <Tabs variant="soft-rounded" colorScheme="green">
          ...
          <TabPanels>
            <TabPanel name="panel1">
              <Text className='text-lg'style={{ lineHeight: '40px' }}>하나AI는 내일</Text>
              <div className='flex'>
                <Text className='text-xl font-semibold'style={{ lineHeight: '10px' }}>원/달러 가격</Text>
                <Text className='text-xl'style={{ lineHeight: '10px' }}>을 얼마라고 예측했을까요?</Text>
              </div>
