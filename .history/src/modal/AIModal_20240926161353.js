...
import { BarChart, Bar, XAxis, YAxis, Tooltip, ResponsiveContainer, Legend, Line, LabelList, ComposedChart, AreaChart } from "recharts";
            ...
            <TabPanel name="panel1">
              ...
              <ResponsiveContainer width="100%" height={150}>
                ...
                >
                  ...
                  {/* Line: today와 tomorrow 예측을 잇는 라인 */}
                  <AreaChart type="monotone" dataKey="today" stroke="#ff7300" name="오늘 예측 라인" />
                  <AreaChart type="monotone" dataKey="tomorrow" stroke="#387908" name="내일 예측 라인" />
                </ComposedChart>
              </ResponsiveContainer>
            </TabPanel>
            <TabPanel>
