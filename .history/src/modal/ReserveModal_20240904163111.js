...
const ReserveModal = ({
  ...
  useEffect(() => {
    console.log("ReserveModal value updated:", value);
  }, [value]);
  ...
  return (
    <ModalContent className="px-6">
      ...
      <div className="flex justify-center items-center mt-2">
        ...
        <Text name="endDate">{value.endDate}</Text> */}
        <Text name="startDate" className="mx-2">
          {value.startDate ? value.startDate.toString() : "N/A"}
        </Text>
        <Text name="endDate" className="mx-2">
          {value.endDate ? value.endDate.toString() : "N/A"}
        </Text>
      </div>
      {/* 마지막 부분 */}
