            ...
            <TabPanel name="panel1" className='mt-5'>
              ...
              <div className='p-3 bg-green-100 rounded-xl mt-6'>
                <div className='flex gap-1'>
                  ...
                  <div className='mt-1'>
                    <Text className='text-sm font-semibold text-green-700'>외환 전문 어시스턴트</Text>
                    <Text className='text-sm font-semibold' style={{ lineHeight: '15px' }}>하나AI</Text>
                  </div>
                </div>
                <Text className='text-sm'>{aiData.todayPredictReason}</Text>
              </div>
            </TabPanel>
            <TabPanel>
              <p>two!</p>
