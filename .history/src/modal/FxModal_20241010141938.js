...
//         원하는 금액
//       </Text>
//       <ExChangeInput value={exchangeValue} setValue={setExchangeValue} changeState={changeState} />
//       {/* 달력 */}
//       {showClander && (
//         <div>
      ...
      <div className="flex justify-end my-2">
        <div>
          ...
          <CountUp
            ...
            duration={2}
            separator=","
            decimals={(selected ? currentInvestPrice : currentSellPrice) % 1 === 0 ? 0 : 0} // 소수점 처리
            decimal="."
            prefix=""
            suffix="원"
          />
