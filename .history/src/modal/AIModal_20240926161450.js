...
import { BarChart, Bar, XAxis, YAxis, Tooltip, ResponsiveContainer, Legend, Line, LabelList, ComposedChart, Area } from "recharts";
            ...
            <TabPanel name="panel1">
              ...
              <ResponsiveContainer width="100%" height={150}>
                ...
                >
                  ...
                  <Area type="monotone" dataKey="today" stroke="#ff7300" name="오늘 예측 라인" />
                  <Area type="monotone" dataKey="tomorrow" stroke="#387908" name="내일 예측 라인" />
                </ComposedChart>
              </ResponsiveContainer>
            </TabPanel>
            <TabPanel>
