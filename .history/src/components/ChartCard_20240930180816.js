...
const ChartCard = ({
  ...
  return (
    <div
      name="card-container"
      className="w-[250px] h-[320px] px-8 py-4 bg-slate-50 rounded-2xl hover:transform hover:scale-95 hover:border hover:border-green-300 transition-all duration-300 ease-in-out"
      style={{
