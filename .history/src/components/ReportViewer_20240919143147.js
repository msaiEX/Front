    ...
    <div className="w-full px-5">
      ...
      <div className="flex justify-center bg-[#d6e1fd] my-4">
        <button
          ...
          className={`w-[25%] px-2 py-2 rounded ${activeButton === 'year' ? 'bg-[#a5ffa5] text-green-700' : 'bg-[#f1f3f8] text-slate-700'}`}
        >
          Year Report
        </button>
        <button
          onClick={() => handleReportChange('month')}
          className={`w-[25%] px-2 py-2  ${activeButton === 'month' ? 'bg-[#a5ffa5] text-green-700' : 'bg-[#f1f3f8] text-slate-700'}`}
        >
          Month Report
        </button>
        <button
          onClick={() => handleReportChange('week')}
          className={`w-[25%] px-2 py-2  ${activeButton === 'week' ? 'bg-[#a5ffa5] text-green-700' : 'bg-[#f1f3f8] text-slate-700'}`}
        >
          Week Report
        </button>
        <button
          onClick={() => handleReportChange('day')}
          className={`w-[25%] px-2 py-2  ${activeButton === 'day' ? 'bg-[#a5ffa5] text-green-700' : 'bg-[#f1f3f8] text-slate-700'}`}
        >
          Day Report
        </button>
      </div>
