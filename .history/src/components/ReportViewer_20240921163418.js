    ...
    <div className="w-full px-5">
      ...
      <div className="flex justify-center bg-[#d6e1fd] my-4">
        ...
        <button
          ...
          className={`w-[25%] px-2 py-2  ${activeButton === 'month' ? 'bg-white border border-blue-700 text-blue-700' : 'bg-[#f1f3f8] text-slate-700'}`}
        >
          Month Report
        </button>
        <button
          onClick={() => handleReportChange('week')}
          className={`w-[25%] px-2 py-2  ${activeButton === 'week' ? 'bg-white border border-blue-700 text-blue-700' : 'bg-[#f1f3f8] text-slate-700'}`}
        >
          Week Report
        </button>
        <button
          onClick={() => handleReportChange('day')}
          className={`w-[25%] px-2 py-2  ${activeButton === 'day' ? 'bg-white border border-blue-700 text-blue-700' : 'bg-[#f1f3f8] text-slate-700'}`}
        >
          Day Report
        </button>
      </div>
