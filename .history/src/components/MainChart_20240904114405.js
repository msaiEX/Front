...
const MainChart = ({ id, changeState }) => {
  ...
  const yAxisDomain = changeState === "JPY" ? [880, 1000] : [1200, 1350];
  ...
  return (
    <div>
      ...
      <div className="w-full flex justify-center items-center">
        <ButtonGroup variant="outline">
          <Button
            className={timeRange === "1D" ? "bg-white" : "bg-slate-200"}
            colorScheme={timeRange === "1D" ? "blue" : "gray"}
            onClick={() => setTimeRange("1D")}
          >
            1D
          ...
          <Button
            className={timeRange === "1M" ? "bg-white" : "bg-slate-200"}
            colorScheme={timeRange === "1M" ? "blue" : "gray"}
            onClick={() => setTimeRange("1M")}
          >
            1M
          ...
          <Button
            className={timeRange === "3M" ? "bg-white" : "bg-slate-200"}
            colorScheme={timeRange === "3M" ? "blue" : "gray"}
            onClick={() => setTimeRange("3M")}
          >
            3M
          ...
          <Button
            className={timeRange === "6M" ? "bg-white" : "bg-slate-200"}
            colorScheme={timeRange === "6M" ? "blue" : "gray"}
            onClick={() => setTimeRange("6M")}
          >
            6M
          ...
          <Button
            className={timeRange === "1Y" ? "bg-white" : "bg-slate-200"}
            colorScheme={timeRange === "1Y" ? "blue" : "gray"}
            onClick={() => setTimeRange("1Y")}
          >
            1Y
