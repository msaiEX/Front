...
//   return (
//     <div className="w-full text-center flex mb-2 py-2 rounded-full" style={{boxShadow: "0 2px 5px rgba(0, 0, 0, 0.1)"}}>
...
import { FaRegStar, FaStar } from "react-icons/fa";  // FaStar는 선택된 상태
import { IoMdArrowDropup, IoMdArrowDropdown } from "react-icons/io";  // up, down 아이콘
import { countryMapperFunction } from './path-to-your-country-mapper';  // countryMapperFunction을 가져옴
