  ...
  return (
    ...
    <div className='flex justify-center items-center'>
      <div name='button-group' className='flex rounded-md bg-slate-200'>
        <div name='button-right' onClick={handleToggle} className={`w-[100px] py-2 text-center rounded-md ${selected ? 'border border-red-500 text-red-500 bg-white' : 'bg-gray-300 text-black'}`}>살래요</div>
