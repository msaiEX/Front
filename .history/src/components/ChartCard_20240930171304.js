...
const ChartCard = ({
  ...
  return (
    <div
      ...
      className="w-[250px] h-[350px] px-8 py-4 bg-slate-50 rounded-2xl hover:transform hover:scale-95 hover:border hover:border-green-300 transition-all duration-300 ease-in-out"
      style={{boxShadow: "0 2px 5px rgba(0, 0, 0, 0.2)", animation: "fadeIn 0.5s ease-in-out" }}
    >
      {/* card 상단 */}
      <div
        name="card-top"
