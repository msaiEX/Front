...
const NewsBar = ({ state, result, url, title, content, imageUrl }) => {
  ...
  return (
    ...
    >
    <div className='w-full box-border flex justify-center py-2 px-10 mb-4 rounded-2xl bg-[#eff6f3] transition-all duration-500 ease-in-out hover:border hover:border-green-500'>
