...
const ReportViewer = () => {
  ...
  const fileLinks = {
    year: '/files/semi2024.pdf',
    month: '/files/Monthly2409.pdf',
    week: '/files/Weekly240909.pdf',
    day: '/files/Daily240913.pdf'
  };
  ...
  return (
    <div className="w-full px-5">
      ...
      <div className="flex justify-center mt-6">
        <a
          href={fileLinks[activeButton]} // 버튼에 맞는 파일 링크 사용
          download // 다운로드 속성 추가
          className="px-4 py-2 bg-blue-500 text-white rounded"
        >
          {reportTitle} PDF 다운로드
        </a>
      </div>
    </div>
  );
