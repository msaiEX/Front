    ...
    <Link
     ...
     >
      ...
      <div name="text-box" className="flex flex-col items-center">
        ...
        <div className="relative w-full flex justify-end items-center pb-4 px-3">
          <Text fontSize={"xl"} as={"b"} className="absolute bottom-0 left-[50%] right-[50%] my-2 grow" color={resultColor}>
            {result}
          </Text>
        </div>
      </div>
