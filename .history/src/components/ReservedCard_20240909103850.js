  ...
  return (
    <div onClick={onClick} className="cursor-pointer">
      <div className='flex gap-1'>
        <Text className='border-2 border-red-400 py-[1px] px-1 rounded-md'>{getTransactionLabel(transaction_type)}</Text>
        <Text className='border-2 border-slate-600 py-[1px] px-1 rounded-md'>예약</Text>
      </div>
      <div className='flex justify-between'>
        <div className='flex'>
          <Image src={countryMapperFunction(currency_code).image}/>
