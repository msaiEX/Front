...
const ChartCard = ({
  ...
  return (
    <div
      ...
      className="w-[250px] h-[350px] px-8 py-4 bg-slate-50 rounded-2xl hover:transform hover:scale-98 hover:border hover:border-slate-300 transition-all duration-300 ease-in-out"
