...
const NewsBar = ({ state, result, url, title, content, imageUrl }) => {
  ...
  return (
    ...
    >
    <div className='w-[880px] h-[104px] flex justify-center py-2 px-10 mb-4 rounded-2xl bg-[#eff6f3] transition-all duration-300 ease-in-out hover:border hover:border-green-500'
      style={{boxSizing: 'border-box'}}
    >
      <div className="w-[780px] flex justify-between items-center gap-3">
        {/* text box */}
        <div name="textbox">
