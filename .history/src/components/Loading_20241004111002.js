  ...
  return (
    ...
    <div className='w-screen h-screen flex justify-center items-center absolute left-0 z-40'>
      ...
      <div className="flex flex-col items-center">
        <div className='w-30 h-20 flex justify-center'>
        
          <Image 
            className="circle h-20 w-20 opacity-100 bg-slate-500 rounded-full"
            src='/image/star_bot.png'  
          ></Image>
        </div>

        <div className="loader"></div>
        <Text className='text-white font-bold mt-5'>하나 AI가 분석하고 있어요{dots}</Text>
      </div>
    </div>
    </>
  );
