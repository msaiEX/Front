    ...
    <div name="card-container" className='w-[300px] h-[450px] p-5 bg-slate-50 rounded-2xl'>
      ...
      <div className='flex justify-between'>
        <div className='flex items-end'>
          <Text className='leading-none' fontSize='1xl'>긍정</Text>
          <Text className='leading-none' fontSize='2xl' as={'b'}>{ positive }%</Text>
        </div>
        <div className='flex items-end'>
          <Text className='leading-none' fontSize='2xl' as={'b'}>{ nagative }%</Text>
          <Text className='leading-none' fontSize='1xl'>부정</Text>
        </div>
      </div>
